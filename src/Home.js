    ...
    <div class="App">
      ...
      <ul class="navbar-nav ml-auto">
         <li class="nav-item">
           ...
           <button type="button" class="btn btn-primary">Contact  <span>          <MdCallMade size={20} /></span></button>
          ...
          <li class="nav-item">
          <div class="d-flex flex-row align-items-center">
<button type="button" class="btn btn-primary">Our Vision <span>          <MdCallMade size={20} /></span></button>
